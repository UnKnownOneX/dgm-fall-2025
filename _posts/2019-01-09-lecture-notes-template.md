...
<figure id="example-figure" class="l-body-outset">
  <div class="row">
    <div class="col one">
      <img src="{{ 'assets/img/notes/lecture-01/cell-ex.png' | [relative_url](https://github.com/UnKnownOneX/dgm-fall-2025/blob/main/assets/img/notes/lecture-01/cell-ex.png) }}" />
    </div>
    <div class="col one">
